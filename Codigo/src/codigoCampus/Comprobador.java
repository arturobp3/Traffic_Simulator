...
public class Comprobador {
	 ...
	 */
	private static void test(String path) throws IOException, ErrorDeSimulacion {
	...
	private static void test(String inFile, String outFile, String expectedOutFile) throws IOException, ErrorDeSimulacion {
	...
	public static void main(String[] args) throws IOException, InvocationTargetException, InterruptedException, ErrorDeSimulacion {		
		test("C://Users//caram//Downloads//Practica5TP//examples//basic");
